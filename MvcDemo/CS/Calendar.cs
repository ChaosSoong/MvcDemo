...
namespace System.Web.Mvc
{
    ...
    public static class CalendarExtensions
    {
        ...
        private static string GenerateHtml(string name, DateTime? date, string format)
        {
            if (date != null)
            {
                return "<input type=\"text\" id=\"" + name + "\" name=\"" + name + "\" onfocus=\"calendar()\" class=\"Wdate\" value=\"" + date.Value.ToString(format) + "\" />";
            }
            else
            {
                return "<input type=\"text\" id=\"" + name + "\" name=\"" + name + "\" onfocus=\"calendar()\" class=\"Wdate\" value=\"\" />";
            }
        }
    }
}